...
async def mx_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Obtener todas las líneas de texto (si responde a un mensaje)
    text = ""
    if msg.reply_to_message and msg.reply_to_message.text:
        text = msg.reply_to_message.text
    elif msg.text and len(context.args) > 0:
        # Si se usa /mx con argumentos
...
# ... (código anterior igual hasta la función refe_handler)
